...
and 'from_env t_gen =
  ...
  ; from_env : 'from_env
  ; expand_var :
      'from_env t_gen -> (Value.t list, Pform.Expansion.t)
...
let expand_var t = t.expand_var t
